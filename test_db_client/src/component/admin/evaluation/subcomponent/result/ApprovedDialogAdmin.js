...
export default function ApprovedDialogAdmin() {
      ...
      >
        ...
        <DialogActions>
                <Button sx={{ m:1}} style={{backgroundColor:"#c8e6c9", color:"#33691e",fontWeight:"800"}} variant="contained" disableElevation size="large" href="http://localhost:3000/AdminDashboard">
                    Hantar untuk Pengesahan BHEPA 
                  </Button>
                <Button sx={{ m:1}} style={{color:"grey"}} onClick={handleClose} size="large"> 
                    Kembali
                  </Button>
        </DialogActions>
      </Dialog>
